...
hhhhhiiiijjjjtemiThis system can be useful for lending institutions to predict the repayment behavior of a client and minimize losses based on simple predictors easily obtainable from clients' data. 
